...
tiff("Figure1.tiff", units="in", width=21, height=6, res=300)
par(mar=c(8,9,4,0), oma=c(0,2,0,1), mgp=c(5,1,0), mfrow=c(1,3))
...
tiff("Figure2.tiff", units="in", width=21, height=6, res=300)
par(mar=c(8,9,4,0), oma=c(0,1,0,1), mgp=c(4.5,1,0), mfrow=c(1,3))
...
stripchart(Biomass ~ FLabel, vertical=TRUE, data=raw_data_week1,
           add=TRUE, pch=1, cex=1.5, col='black')
...
tiff("Figure3.tiff", units="in", width=21, height=6, res=300)
par(mar=c(8,9,4,0), oma=c(0,2,0,1), mgp=c(4.5,1,0), mfrow=c(1,3))
